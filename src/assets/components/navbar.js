        ...
        <div class="navbar-fixed">
            <nav>
                <div class="nav-wrapper container">
                    <a href="#home" class="home brand-logo left"><img class="trophy-logo" src="assets/icons/icon-72x72.png" alt="trophy">My League</a>
                    <a class="sidenav-trigger hide-on-large-only right" data-target="menu-side" href="#">
